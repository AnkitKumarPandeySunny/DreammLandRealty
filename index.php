...
<body>
  <div class="bg-white p-0">
    ...
    <div class="container-fluid nav-bar bg-transparent">
      <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
        <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
          <!-- src="img/drem_land_logo_only.png" -->
          <div class="p-2 me-2">
            <img class="img-fluid" src="img/drem_land_logo.png" alt="Icon" style="width: 90px; height: 90px" />
            <!-- <img class="img-fluid" src="img/icon-deal.png" alt="Icon" style="width: 30px; height: 30px;"> -->
          </div>
          <h1 class="m-0 text-primary navbar-brand-text">
            Dreamm Land Realty
          </h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto">
            ...
            <!-- <a href="contact.html" class="nav-item nav-link">Contact3</a> -->

          </div>
          <img class="img-fluid" src="img/iso.jpg" alt="Icon" style="width: 90px; height: 82px" />
        </div>
      </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="bg-white heroSectionContainerMain p-0">
      <?php include('./src/landingPageComp/sliderImage.php')?>
      ...
      <div class="row g-0 gx-5 align-items-end">
        <div class="col-lg-6">
          <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
            <h1 class="mb-3">Listed Property</h1>
            <p>
              “Explore the best properties, handpicked for quality, location, and value.
              From cozy homes to premium spaces — we list only the finest.
        ...
        <div id="tab-1" class="tab-pane fade show p-0 active">
          <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden" style="height:250px; width:100%;">
                  <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/property-1.jpg"
                    alt="" />
                ...
                <div class="p-4 pb-0">
                  <h5 class="text-primary mb-3">Rs ....</h5>
                  <a class="d-block h5 mb-2" href="">TITLE</a>
                  <p>
                    <i class="fa fa-map-marker-alt text-primary me-2"></i>Address...
                  </p>
                </div>
                ...
                <div class="d-flex bg-primary text-white" role="button" data-bs-toggle="modal"
                  data-bs-target="#contactModal" data-property-name="Golden Urban House For Sell"
                  data-property-price="$12,345" data-property-location="Address...">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden" style="height:250px; width:100%;">
                  <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/property-3.jpg"
                    alt="" />
                  <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                    Featured
                  </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden" style="height:250px; width:100%;">
                  <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/property-4.jpg"
                    alt="" />
                  <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                    Featured
                  </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden" style="height:250px; width:100%;">
                  <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/property-5.jpg"
                    alt="" />
                  <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                    Featured
                  </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="property-item rounded overflow-hidden">
                <div class="position-relative overflow-hidden" style="height:250px; width:100%;">
                  <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/property-6.jpg"
                    alt="" />
                  <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                    Featured
                  </div>
        ...
        <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, 0.3)">
          <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <button class="btn btn-dark py-3 px-4" data-bs-toggle="modal" data-bs-target="#getAppoitmentModal">
  ...
  <div class="py-5">
    <div class="container">
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
        ...
        <p>
          Together with our partners, we build lasting impact. <br>Their expertise and commitment empower us to reach
      ...
      <div class="owl-carousel partners-carousel wow fadeInUp" data-wow-delay="0.1s">
        <div class="team-item rounded overflow-hidden">
          <div class="position-relative" style="height:350px; width:100%;">
            <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/Arpita.jpg" alt="" />
          ...
          <div class="text-center p-4 mt-3">
            <h5 class="fw-bold mb-0">Sraboni Biswas</h5>
            <small>A.G.M</small><br />
            <small>+91 9144144034
            </small>
          </div>
        </div>
        <div class="team-item rounded overflow-hidden">
          <div class="position-relative" style="height:350px; width:100%;">
            <img class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;" src="img/ArpitaKarmakar.jpg"
              alt="" />
            <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
              <a class="btn btn-square mx-1" href="https://www.facebook.com/arpita.arpita.656617?mibextid=ZbWKwL"><i
          ...
          <!-- </div>
            <div class="team-item rounded overflow-hidden">
              <div class="position-relative">
                <img class="img-fluid" src="img/JhumaMukherjee.jpg" alt="" />
                <div
                  class="position-absolute start-50 top-100 translate-middle d-flex align-items-center"
                >
                  <a class="btn btn-square mx-1" href="https://www.facebook.com/profile.php?id=61561734436619&mibextid=ZbWKwL"
                    ><i class="fab fa-facebook-f"></i
                  ></a> -->
          <!-- <a class="btn btn-square mx-1" href=""
                    ><i class="fab fa-twitter"></i
                  ></a> -->
          <!-- <a class="btn btn-square mx-1" href="https://www.instagram.com/realtor_shruti?igsh=MXh5Z3U3M2xtYTlydA=="
                    ><i class="fab fa-instagram"></i
                  ></a>
                </div>
              </div> -->
          <!-- <div class="text-center p-4 mt-3">
                <h5 class="fw-bold mb-0">Jhuma Mukherjee</h5>
                <small>Assistant Office In-charge</small><br />
                <small>+91 9144144041</small>
              </div> -->
          <!-- </div>
            <div class="team-item rounded overflow-hidden">
              <div class="position-relative">
                <img class="img-fluid" src="img/PriyaSutradhar.jpg" alt="" />
                <div
                  class="position-absolute start-50 top-100 translate-middle d-flex align-items-center"
                >
                  <a class="btn btn-square mx-1" href="https://www.facebook.com/share/75oBqBRXc4Hu22Jh/"
                    ><i class="fab fa-facebook-f"></i
                  ></a> -->
          <!-- <a class="btn btn-square mx-1" href=""
                    ><i class="fab fa-twitter"></i
                  ></a> -->
          <!-- <a class="btn btn-square mx-1" href="https://www.instagram.com/propertyrealtormisti?igsh=MXh1bHliMW8yN3Aweg=="
                    ><i class="fab fa-instagram"></i
                  ></a>
                </div>
              </div> -->
          <!-- <div class="text-center p-4 mt-3">
                <h5 class="fw-bold mb-0">Priya Sutradhar</h5>
                <small>Assistant Manager</small><br />
                <small>+91 8695532025
                </small>
              </div> -->
        </div>
        <!-- <div class="team-item rounded overflow-hidden">
              <div class="position-relative">
                <img class="img-fluid" src="img/ManishaRoy.jpg" alt="" />
                <div
                  class="position-absolute start-50 top-100 translate-middle d-flex align-items-center"
                >
                  <a class="btn btn-square mx-1" href="https://www.facebook.com/riya.roy.668838?mibextid=ZbWKwL"
                    ><i class="fab fa-facebook-f"></i
                  ></a>
        ...
        <!-- <div class="text-center p-4 mt-3">
                <h5 class="fw-bold mb-0">Manisha Roy</h5>
                <small>Relationship Manager</small><br />
                <small>+91 9144144029
                </small>
              </div> -->
      </div>
  ...
  <div class="py-5">
    <div class="container">
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
        ...
        <p>
          "We couldn’t be happier with the results! Professional, <br>reliable, and truly dedicated — they went above
      ...
      <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
        <div class="testimonial-item bg-light rounded p-3">
          <div class="bg-white border rounded p-4">
            <p>
              "Absolutely thrilled with the service! Everything was handled with care and precision. We’re 100%
        ...
        <div class="testimonial-item bg-light rounded p-3">
          <div class="bg-white border rounded p-4">
            <p>
              "The team provided exceptional service! We saw remarkable improvements in our business after their
        ...
        <div class="testimonial-item bg-light rounded p-3">
          <div class="bg-white border rounded p-4">
            <p>
              "Truly impressed with the level of professionalism and dedication shown. Their work exceeded our
    ...
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-5 col-md-5">
          <h5 class="text-white mb-4">Feel free to reach us</h5>
          <p class="mb-2">
            <i class="fa fa-map-marker-alt me-3"></i>Karunamoye Housing
            Estate, Roy House, Near Ragunath niwas, Beside HLG Hospital,
            Asansol, WB-713305.
          </p>
          <p class="mb-2">
            <i class="fa fa-phone-alt me-3"></i>+91 7047944758
          </p>
          <p class="mb-2">
            <i class="fa fa-envelope me-3"></i>dreamlandrealty2022@gmail.com
          </p>
        ...
        <div class="col-lg-4 col-md-2">
          <h5 class="text-white mb-4 text-center">Subsidiaries</h5>
          <div class="d-flex">
            <div class="position-relative mx-auto" style="max-width: 400px">
              <img src="./img/msKarmakar.png" style="width: 90%; height: 90%" />
            </div>
            <div class="position-relative mx-auto" style="max-width: 400px">
              <img src="./img/tax2.png" style="width: 90%; height: 100%" />
            </div>
            <!-- <div class="position-relative mx-auto" style="max-width: 400px">
              <img src="./img/iso-certified.png" style="width: 100%; height: 100%" />
            </div> -->
          </div>
        </div>
      </div>
      ...
      <div class="copyright">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            &copy; <a class="border-bottom" href="/">DREAMM LAND</a>, All
            Right Reserved. Design & Maintain's By Accenutrix
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="getAppoitmentModal" tabindex="-1" aria-labelledby="contactModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
